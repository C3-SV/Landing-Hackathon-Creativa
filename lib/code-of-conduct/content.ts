...
export const codeOfConductSections: CodeOfConductSection[] = [
  {
    title: "Propósito",
    content: [
      "Este Código de Conducta establece las reglas mínimas de convivencia y participación para la Hackathon de Turismo Creativo Vol. 1.",
      "Su objetivo es asegurar un ambiente seguro, respetuoso, colaborativo y enfocado en la creación de soluciones con impacto.",
    ],
  },
  {
    title: "Principios del evento",
    content: [
      "La hackathon existe para construir, aprender y conectar. Todas las personas participantes, mentoras, juradas, organizadoras, voluntarias y aliadas deben actuar con respeto, apertura y responsabilidad durante todo el evento.",
      "Principios base:",
      "- Respeto hacia todas las personas.",
      "- Colaboración entre equipos, mentores y participantes.",
      "- Honestidad en el trabajo presentado.",
  ...
  },
  {
    ...
    content: [
      ...
      "- Mantener una comunicación clara y responsable con el equipo organizador.",
      "- Evitar cualquier conducta que afecte la seguridad, tranquilidad o participación de otras personas.",
    ],
  },
  {
    ...
    content: [
      ...
      "- Comunicar al equipo organizador cualquier salida temporal, especialmente durante horarios de trabajo, descanso o pernocta.",
      "- Seguir las indicaciones de Key Institute, seguridad, voluntariado y organización.",
    ],
  },
  {
    title: "Reglas del espíritu colaborativo",
    content: [
      "La hackathon no busca únicamente que los equipos compitan. También busca que las personas se conozcan, conversen, compartan perspectivas y construyan conexiones útiles para el futuro.",
      "Se promueve:",
      ...
      "- Construir una comunidad donde la colaboración multiplica el valor del evento.",
    ],
  },
  {
  ...
  },
  {
    ...
    content: [
      ...
      "- Daño a instalaciones, materiales, equipos o recursos compartidos.",
      "- Incumplimiento deliberado de instrucciones de la organización.",
      "- Cualquier acción que ponga en riesgo la seguridad o bienestar de otras personas.",
    ],
  },
  {
    title: "Reporte y actuación",
    content: [
      "Cualquier persona que observe o viva una situación incómoda, irrespetuosa o contraria a este Código de Conducta podrá reportarla al equipo organizador.",
      "La organización revisará cada caso y tomará medidas proporcionales según la gravedad de la situación.",
      "Medidas posibles:",
      "- Conversación o advertencia directa.",
  ...
  },
  {
    ...
    content: [
      "Al participar en la Hackathon de Turismo Creativo Vol. 1, cada persona acepta contribuir a una experiencia respetuosa, colaborativa y orientada al aprendizaje.",
      "La hackathon es una oportunidad para crear soluciones, conectar con el ecosistema y demostrar que el talento crece mejor cuando se crea y colabora con responsabilidad.",
    ],
  },
];
